...
currentAccount = CurrentAccount('Jija Traders', 10000, 2)
print("withdraw to exhaust the minmum balance for current account")
currentAccount.withdraw(30000)
print("updated Current account")
currentAccount.printMe()

print("Updated Current balance")
currentAccount.printMe()
print("withdraw more than minimum balance")
